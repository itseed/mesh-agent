export function IconLoader({ size = 80, className }: { size?: number; className?: string }) {
  return (
    ...
    >
      ...
      <circle className="ring-outer" cx="60" cy="60" r="44" fill="none" stroke="#58a6ff" strokeWidth="1" opacity="0.2"/>

      {/* mid ring — spins CW */}
      <circle className="ring-mid" cx="60" cy="60" r="27" fill="none" stroke="#58a6ff" strokeWidth="1.5" opacity="0.5"/>
      ...
      <g className="hub-rings">
        <circle cx="60" cy="60" r="10" fill="none" stroke="#58a6ff" strokeWidth="2.5" opacity="0.95"/>
